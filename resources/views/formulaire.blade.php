...
<style>
    ...
    .ui-keyboard-button {
        width: auto;
        height: 1.5rem; /* Adjusted height for better visibility */
        margin-left: 2px;
        margin-top: 2px;
        font-weight: bold;
...
<script>
    $(document).ready(function() {
        $('#nom-ar').keyboard({
            ...
            customLayout: {
                'default': [
                    '{tab} ض ص ق ف غ ع ه خ ح ج د ',
                    'ش س ي ب ل أ ت ن م ك ط {enter}',
                    ' ئ ء ؤ ر ل ا  ث لا ت و  ن م ك ط ',
                    ' {space} {left} {right}'
                ]
            },
            usePreview: false,
...
<div class="content__inner">
  <div class="container">
    ...
    <!--animations form-->
    <form class="pick-animation my-4" action="{{ route('ajoute') }}" method="POST" enctype="multipart/form-data">
      
    @csrf
      <div class="form-row">
        <div class="col-5 m-auto">
          <input type="file" class="pick-animation__select form-control" name="photo" value="  Choisir votre Photo" />
          ...
          <form class="multisteps-form__form">
              ...
              <div class="multisteps-form__content">
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                    ...
                    <input class="multisteps-form__input form-control" id="prenom-ar" name="prenom_ar" type="email" placeholder="ادخل اسم العائلي"/>
                  </div>
                </div>
                <div class="form-row mt-4">
                  <div class="col-12 col-sm-6">
                ...
                <div class="form-row mt-4">
                    ...
                    <label for="form-label"> Privance naissance  *:     </label>
                      ...
                      <input class="multisteps-form__input form-control" type="text" name="provance_naissance"  placeholder="Entrez notre Privance naissance "/>
                    </div>
                ...
                <div class="button-row d-flex mt-4">
                  <button class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" onclick=" Achraf() 
            ...
            <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="slideHorz">
              ...
              <div class="multisteps-form__content">
                ...
                <div class="button-row d-flex mt-4">
                  <button class="btn btn-primary ml-auto js-btn-prev" type="button" title="Next" onclick=" Achraf() 
